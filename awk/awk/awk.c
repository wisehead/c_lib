...
main(int argc, char *argv[])
{
	...
	printf("# AIO_LISTIO_MAX defined to be %ld\n", (long)# AIO_LISTIO_MAX+0);
#else
	printf("no symbol for # AIO_LISTIO_MAX\n");
#endif
*/
#ifdef _SC_AIO_LISTIO_MAX
	pr_sysconf("# AIO_LISTIO_MAX =", _SC_AIO_LISTIO_MAX);
#else
	printf("no symbol for _SC_AIO_LISTIO_MAX\n");
#endif
	/*
#ifdef # AIO_MAX
	printf("# AIO_MAX defined to be %ld\n", (long)# AIO_MAX+0);
#else
	printf("no symbol for # AIO_MAX\n");
#endif
*/
#ifdef _SC_AIO_MAX
	pr_sysconf("# AIO_MAX =", _SC_AIO_MAX);
#else
	printf("no symbol for _SC_AIO_MAX\n");
#endif
	/*
#ifdef # AIO_PRIO_DELTA_MAX
	printf("# AIO_PRIO_DELTA_MAX defined to be %ld\n", (long)# AIO_PRIO_DELTA_MAX+0);
#else
	printf("no symbol for # AIO_PRIO_DELTA_MAX\n");
#endif
*/
#ifdef _SC_AIO_PRIO_DELTA_MAX
	pr_sysconf("# AIO_PRIO_DELTA_MAX =", _SC_AIO_PRIO_DELTA_MAX);
#else
	printf("no symbol for _SC_AIO_PRIO_DELTA_MAX\n");
#endif
#ifdef ARG_MAX
...
#endif
	/*
#ifdef # initial size of getgrgid_r()
	printf("# initial size of getgrgid_r() defined to be %ld\n", (long)# initial size of getgrgid_r()+0);
#else
	printf("no symbol for # initial size of getgrgid_r()\n");
#endif
*/
#ifdef _SC_GETGR_R_SIZE_MAX
	pr_sysconf("# initial size of getgrgid_r() =", _SC_GETGR_R_SIZE_MAX);
#else
	printf("no symbol for _SC_GETGR_R_SIZE_MAX\n");
#endif
	/*
#ifdef # initial size of getpwuid_r()
	printf("# initial size of getpwuid_r() defined to be %ld\n", (long)# initial size of getpwuid_r()+0);
#else
	printf("no symbol for # initial size of getpwuid_r()\n");
#endif
*/
#ifdef _SC_GETPW_R_SIZE_MAX
	pr_sysconf("# initial size of getpwuid_r() =", _SC_GETPW_R_SIZE_MAX);
#else
	printf("no symbol for _SC_GETPW_R_SIZE_MAX\n");
#endif
#ifdef OPEN_MAX
	...
	printf("# PTHREAD_DESTRUCTOR_ITERATIONS defined to be %ld\n", (long)# PTHREAD_DESTRUCTOR_ITERATIONS+0);
#else
	printf("no symbol for # PTHREAD_DESTRUCTOR_ITERATIONS\n");
#endif
*/
#ifdef _SC_THREAD_DESTRUCTOR_ITERATIONS
	pr_sysconf("# PTHREAD_DESTRUCTOR_ITERATIONS =", _SC_THREAD_DESTRUCTOR_ITERATIONS);
#else
	printf("no symbol for _SC_THREAD_DESTRUCTOR_ITERATIONS\n");
#endif
	/*
#ifdef # PTHREAD_KEYS_MAX
	printf("# PTHREAD_KEYS_MAX defined to be %ld\n", (long)# PTHREAD_KEYS_MAX+0);
#else
	printf("no symbol for # PTHREAD_KEYS_MAX\n");
#endif
*/
#ifdef _SC_THREAD_KEYS_MAX
	pr_sysconf("# PTHREAD_KEYS_MAX =", _SC_THREAD_KEYS_MAX);
#else
	printf("no symbol for _SC_THREAD_KEYS_MAX\n");
#endif
	/*
#ifdef # PTHREAD_STACK_MIN
	printf("# PTHREAD_STACK_MIN defined to be %ld\n", (long)# PTHREAD_STACK_MIN+0);
#else
	printf("no symbol for # PTHREAD_STACK_MIN\n");
#endif
*/
#ifdef _SC_THREAD_STACK_MIN
	pr_sysconf("# PTHREAD_STACK_MIN =", _SC_THREAD_STACK_MIN);
#else
	printf("no symbol for _SC_THREAD_STACK_MIN\n");
#endif
	/*
#ifdef # PTHREAD_THREADS_MAX
	printf("# PTHREAD_THREADS_MAX defined to be %ld\n", (long)# PTHREAD_THREADS_MAX+0);
#else
	printf("no symbol for # PTHREAD_THREADS_MAX\n");
#endif
*/
#ifdef _SC_THREAD_THREADS_MAX
	pr_sysconf("# PTHREAD_THREADS_MAX =", _SC_THREAD_THREADS_MAX);
#else
	printf("no symbol for _SC_THREAD_THREADS_MAX\n");
#endif
#ifdef RE_DUP_MAX
